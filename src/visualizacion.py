...
with definir_particula:
    ...
    st.session_state.user.params["x0"]=st.number_input(r"Posición inicial $(x_0)$",min_value=st.session_state.user.params["grillaI"],max_value=st.session_state.user.params["grillaD"],value=0.0,step=1.0)
